#!/usr/bin/env python3
"""
Upload Jornada 11 PSE data directly to database
"""
import sys
import pandas as pd
...
def upload_jornada11_pse():
    """Upload Jornada 11 PSE data after GPS session is created"""
    print("🚀 Uploading Jornada 11 PSE data...")
    ...
    try:
        ...
        # Get the most recent Jornada 11 session
        session_query = """
        ...
        if not sessions:
            print(f"❌ No Jornada 11 session found!")
        ...
        if inserted > 0:
            print("🎉 Jornada 11 PSE data uploaded successfully!")
